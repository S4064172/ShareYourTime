<?php
	...
	insertInto_ShareYourJobsTime("Insegno ad usare il pacchetto Office2017", 5, $time1S, $time1E, $now, 2, "DEFAULT", "via pia", 86.51, 77.41, "pippo", "INFORMATICA");
	updataInto_ShareYourJobsTime('Receiver','kenny' , 1);
	
	insertInto_ShareYourJobsTime("Riparo tubature e condotti idraulici tra cui impianti di irrigazione", 20, $time2S, $time2E, $days3, 4, "DEFAULT", "corso ricci", 12.39, 36.88, "kenny", "IDRAULICA");
	updataInto_ShareYourJobsTime('Receiver', 'pippo', 2);
	
	insertInto_ShareYourJobsTime("Insegno a fare gli aquiloni", 10, $time3S, $time3E, $days1, 1, "DEFAULT", "via XX settembre", 15.53, 44.57, "pippo", "FAI DA TE");
	updataInto_ShareYourJobsTime('Receiver', 'kenny', 3);
	
	insertInto_ShareYourJobsTime("Taglio il prato e gli alberi che ostacolano la strada", 50, $time4S, $time4E, $days2, 10, "DEFAULT", "via ferragiana", 66.45, 39.74, "pippo", "GIARDINAGGIO");
	insertInto_ShareYourJobsTime("Preparo pranzo a domicilio", 15, $time5S, $time5E, $days6, 1, "DEFAULT", "corso viglienzoni", 7.56, 8.94, "kenny", "CUCINA");
	insertInto_ShareYourJobsTime("Lavo le scale negli appartamenti", 60, $time6S, $time6E, $days2, 2, "DEFAULT", "via gramsci", 55.99, 23.31, "pippo", "LAVAGGIO");

	
	insertInto_ShareYourJobsTime("Lavo le scale negli appartamenti1", 60, $time7S, $time7E, $days_2, 2, "DEFAULT", "via gramsci", 55.99, 23.31, "pippo", "LAVAGGIO");
	updataInto_ShareYourJobsTime('Receiver', 'kenny', 7);
	updataInto_ShareYourJobsTime('Evaluation', 5, 7);

	insertInto_ShareYourJobsTime("Lavo le scale negli appartamenti2", 60, $time8S, $time8E, $days1, 2, "DEFAULT", "via gramsci", 55.99, 23.31, "kenny", "LAVAGGIO");
	insertInto_ShareYourJobsTime("Lavo le scale negli appartamenti3", 60, $time7S, $time7E, $days_2, 2, "DEFAULT", "via gramsci", 55.99, 23.31, "kenny", "LAVAGGIO");
	
	insertInto_ShareYourJobsTime("Lavo le scale negli appartamenti4", 60, $time7S, $time7E, $days_2, 2, "DEFAULT", "via gramsci", 55.99, 23.31, "kenny", "LAVAGGIO");
	updataInto_ShareYourJobsTime('Receiver', 'pippo', 10);
	updataInto_ShareYourJobsTime('Evaluation', 4, 10);

	insertInto_ShareYourJobsTime("Lavo le scale negli appartamenti5", 60, $time7S, $time7E, $days_2, 2, "DEFAULT", "via gramsci", 55.99, 23.31, "pippo", "LAVAGGIO");
