  ...
  <head>
	...
	<section  id="homeView" >
      ...
      <!--
          -> Login a scomparsa
      -->	
	<div class="modal myModal fade" id="loginModalTarget" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					...
					<div class="container myContainer">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<label for="telephone" class="text-r"><b>Telefono(opzionale)</b></label>
									<input type="tel" placeholder="Inserisci un numero di telefono" name="telephone" minlength="10" maxlength="10">
							</div>
						</div>
